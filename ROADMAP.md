...
1. Edit the module in `tools/sprite_art/`: enemies (`imp.py`, `demon.py`, `soldier.py`, `baron.py`),
   first-person weapons (`weapons.py`), pickups (`items.py`) or the portal design (`portal.py`).
